package com.hresource.app.server.businessservice.humanresourceboundedcontext.attendance.aspect;
...
public class BusinessServiceattendanceAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hresource.app.server.businessservice.humanresourceboundedcontext.attendance..*(..))")
