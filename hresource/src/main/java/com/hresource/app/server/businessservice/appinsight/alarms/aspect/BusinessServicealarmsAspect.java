package com.hresource.app.server.businessservice.appinsight.alarms.aspect;
import com.hresource.app.server.businessservice.aspect.BusinessAspect;
...
public class BusinessServicealarmsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hresource.app.server.businessservice.appinsight.alarms..*(..)) && !alarmOperation()")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.hresource.app.server.businessservice.appinsight.alarms.AppLogAlarmGenerationBizService..*(..))")
