package com.hresource.app.server.businessservice.appbasicsetup.userrolemanagement.aspect;
...
public class BusinessServiceuserrolemanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hresource.app.server.businessservice.appbasicsetup.userrolemanagement..*(..))")
