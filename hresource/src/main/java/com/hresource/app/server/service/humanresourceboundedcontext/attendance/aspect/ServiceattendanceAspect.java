package com.hresource.app.server.service.humanresourceboundedcontext.attendance.aspect;
import com.hresource.app.server.service.aspect.ServiceAspect;
...
public class ServiceattendanceAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.hresource.app.server.service.humanresourceboundedcontext.attendance..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.hresource.app.server.service.humanresourceboundedcontext.attendance..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.hresource.app.server.service.humanresourceboundedcontext.attendance..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.hresource.app.server.service.humanresourceboundedcontext.attendance..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.hresource.app.server.service.humanresourceboundedcontext.attendance..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.hresource.app.server.service.humanresourceboundedcontext.attendance..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.hresource.app.server.service.humanresourceboundedcontext.attendance..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
