package com.hresource.app.server.businessservice.humanresourceboundedcontext.employee.aspect;
...
public class BusinessServiceemployeeAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hresource.app.server.businessservice.humanresourceboundedcontext.employee..*(..))")
