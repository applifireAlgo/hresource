package com.hresource.app.server.businessservice.organization.contactmanagement.aspect;
...
public class BusinessServicecontactmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hresource.app.server.businessservice.organization.contactmanagement..*(..))")
