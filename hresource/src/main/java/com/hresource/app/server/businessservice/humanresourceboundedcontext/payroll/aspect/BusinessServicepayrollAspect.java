package com.hresource.app.server.businessservice.humanresourceboundedcontext.payroll.aspect;
...
public class BusinessServicepayrollAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hresource.app.server.businessservice.humanresourceboundedcontext.payroll..*(..))")
