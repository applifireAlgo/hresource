package com.hresource.app.server.businessservice.appbasicsetup.aaa.aspect;
...
public class BusinessServiceaaaAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hresource.app.server.businessservice.appbasicsetup.aaa..*(..))")
