package com.hresource.app.server.businessservice.appinsight.health.aspect;
...
public class BusinessServicehealthAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.hresource.app.server.businessservice.appinsight.health..*(..))")
