package com.hresource.app.server.repository.organization.locationmanagement.aspect;
...
public class RepositorylocationmanagementAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.hresource.app.server.repository.organization.locationmanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.hresource.app.server.repository.organization.locationmanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.hresource.app.server.repository.organization.locationmanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.hresource.app.server.repository.organization.locationmanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.hresource.app.server.repository.organization.locationmanagement..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.hresource.app.server.repository.organization.locationmanagement..*(..)) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation() && ! getOperation()")
