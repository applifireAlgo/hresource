...
public class UserAccessDomain implements Serializable, CommonEntityInterface, Comparator<UserAccessDomain> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hresource.app.shared.appbasicsetup.usermanagement.UserAccessDomain other = (com.hresource.app.shared.appbasicsetup.usermanagement.UserAccessDomain) obj;
            if (userAccessDomainId == null) {
                return false;
