...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            com.hresource.app.shared.organization.contactmanagement.CommunicationData other = (com.hresource.app.shared.organization.contactmanagement.CommunicationData) obj;
            if (commDataId == null) {
                return false;
