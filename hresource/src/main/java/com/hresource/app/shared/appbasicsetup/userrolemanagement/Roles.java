package com.hresource.app.shared.appbasicsetup.userrolemanagement;
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<com.hresource.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.hresource.app.shared.appbasicsetup.userrolemanagement.Roles other = (com.hresource.app.shared.appbasicsetup.userrolemanagement.Roles) obj;
            if (roleId == null) {
                return false;
