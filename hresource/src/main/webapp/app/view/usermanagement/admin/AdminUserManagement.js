Ext.define('Hresource.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Hresource.view.usermanagement.admin.UserPasswordReset',
	            'Hresource.view.usermanagement.admin.AddUserDetails',
	            'Hresource.view.usermanagement.admin.ViewUser'],
