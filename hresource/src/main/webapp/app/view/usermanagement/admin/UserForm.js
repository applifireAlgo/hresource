Ext.define('Hresource.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Hresource.view.usermanagement.admin.AddUserDetailsViewModel', 'Hresource.model.AddUserDataModel' ],
