Ext.define('Hresource.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Hresource.view.usermanagement.enduser.UserProfileController', 'Hresource.view.usermanagement.admin.AddUserDetailsViewModel', 'Hresource.model.AddUserDataModel' ],
