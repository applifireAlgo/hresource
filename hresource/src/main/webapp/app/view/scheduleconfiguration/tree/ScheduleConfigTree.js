 ...
 * 
 */
Ext.define("Hresource.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Hresource.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
