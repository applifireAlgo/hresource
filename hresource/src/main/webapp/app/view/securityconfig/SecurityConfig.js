 ...
 * 
 */
Ext.define('Hresource.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Hresource.view.securityconfig.SecurityConfigController',
			'Hresource.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
