 ...
 * 
 */
Ext.define('Hresource.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Hresource.view.logalarm.mainscreen.AddLogAlarmController',
			'Hresource.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Hresource.view.logalarm.mainscreen.AppAlarmPanel',
