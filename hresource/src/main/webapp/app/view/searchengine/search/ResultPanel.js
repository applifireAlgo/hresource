Ext
		.define(
				'Hresource.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Hresource.view.searchengine.search.SearchEngineMainPanelController','Hresource.view.searchengine.search.PanelHeaderField' ,'Hresource.view.searchengine.search.ReportGridView','Hresource.view.searchengine.search.ReportChartView','Hresource.view.searchengine.search.documentView','Hresource.view.searchengine.search.DouMeanView','Hresource.view.googlemaps.map.MapPanel'],
