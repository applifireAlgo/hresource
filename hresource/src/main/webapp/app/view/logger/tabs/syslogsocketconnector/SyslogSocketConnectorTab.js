 ...
 * 
 */
Ext.define('Hresource.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Hresource.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
