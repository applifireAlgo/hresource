...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelDescription("vHZEGvn3qNOQlrKNy9HrClic869Nf0oULLRIXXsFLaT4eB0QEn");
        useraccesslevel.setLevelIcon("WpOoqVC5gxJlXkTTuXe8Q0lq9oy3a5mEsPP95P7Jtpw5DSunyn");
        useraccesslevel.setLevelHelp("wCin5BdGOJ0tqTggyAxVj0PCjJPt1qSLY52JGameMvZoAu5EDq");
        useraccesslevel.setLevelName("6zi1OvYbxuIfwTlGZ9YyPpCBntoMky9DtLcElMJdsaJKz5YCFL");
        ...
        useraccessdomain.setDomainIcon("RHZxHtZBjagppLOb5pGIbGAzLoTHaFQiWYmi1UqS7WS6bf6SD2");
        useraccessdomain.setDomainHelp("GNF8EIfQZj26SvyK6APkcr95xcP5JqjGCn7hCsMnmX5CDX3kQH");
        useraccessdomain.setDomainDescription("oo6Q0AhP1OvANUZTtOqdE9RMKWJXBAH3HiLhKkpWyKLrI56L2j");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainName("SkdxTKRoW90Q43vGP8E3X791JkNpsUugK2sURBJqasscl539EN");
        ...
        User user = new User();
        user.setUserAccessCode(44935);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsLocked(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1465218741680l));
        user.setGenTempOneTimePassword(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsDeleted(1);
        user.setSessionTimeout(3433);
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1465218741714l));
        user.setChangePasswordNextLogin(1);
        user.setPasswordAlgo("WMIiO92emLozgEyAMAy3xyWpfbxd9heZaW8k5Sc1GsNpp3ATB0");
        user.setAllowMultipleLogin(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("XgEF4XorZ1fwJgC1ARmv5YpKQPIDoMl6J72Jvle4cxn0aVU67k");
        Question question = new Question();
        question.setQuestion("Uu1friFeZDzM0HuH15AZSYmN88EwQiUKj7gncfTMqGgGgdZDEx");
        question.setLevelid(7);
        question.setQuestionDetails("ByP7cxhGG8");
        question.setQuestionIcon("o3JzifoS45Whs4uuFTb1V24DTT6FnU3A8d6T8HDK0CyThMz7A3");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("aC7nBhCJuEIaffn0Z4p1xHwqxpgnWCqW0wV2KqYSw30zWj879D");
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        passrecovery.setUser(user);
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setLast5Passwords("if2iWe7gWvFxdLxqsKMCYnfdDc0lJeqdrTMgsBT3ghPTPCj4ZY");
        userdata.setOneTimePasswordExpiry(1);
        userdata.setOneTimePassword("0KbgyEiADsc4irkRSn2ze2uU63BjHJBu");
        userdata.setLast5Passwords("0cBYwflwLQ7O91wnQH4dNJRD4c3BuHlUyhfOhaaS8zNAcvVa6j");
        userdata.setOneTimePasswordExpiry(7);
        userdata.setOneTimePassword("PRfPbJTLxIL1rS4qN3vThW3GFduYpDqa");
        userdata.setUser(user);
        userdata.setPassword("NEpfKufJjlT1oU0O89j3kh8OgMBUJuM3ROaHQUNQ3Zzh3peDnf");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1465218741951l));
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 92486));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "rIVjHIUbU18ZnjoMTMUZ2ToMgbWAziQ8WwRvwlvNzzy4wfq5FQLRA5OWjlLSGsfCU"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 6432));
