...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestion("5fzElBYMXZL1vBCQTFwphSd1qHg9D7prUZ3AcnfGdq5pyEFRBs");
        question.setLevelid(6);
        question.setQuestionDetails("9Z5KtDXdTv");
        question.setQuestionIcon("5brkfO3Y1QiwtOEpR01GNypQIQy9Cj22exigANqlvDt9VYY9K4");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("w7WqVUoSw87p3kDePYPh7hxU8nc2QH2i1tf7OSlGXFRobpMoqr");
            question.setLevelid(2);
            question.setQuestionDetails("90wqbdC1NY");
            question.setQuestionIcon("qnsWOZSk5fG6HrtdEnuBiMUVMwf3h6ZpthUIo20eF8kIP2D1mU");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "YbMWvgkKdZi2JaK71MyQ1E5AV8AwK8nnoQkd0Ivsw9zSbETP1LLNSgbyFWz9ZB3Jw"));
